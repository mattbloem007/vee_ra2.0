...
console.log("TOKEN", process.env.SHOP_TOKEN)
console.log("NAME", process.env.SHOP_NAME)
const client = Client.buildClient({
  storefrontAccessToken: "e48e3a07a4dea28b6ad4aa65d5214e81",
  domain: `u8chnc-qf.myshopify.com`,
})
